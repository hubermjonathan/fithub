...
let Profile = new Schema({
    ...
    workouts: [{ type: Schema.Types.ObjectId, ref: "WorkoutTemplate"}],         //Workout plans the user has submitted to the master list
    exercises: [{ type: Schema.Types.ObjectId, ref: "ExerciseTemplate"}],         //Private exercises
    logs: [{ type: Schema.Types.ObjectId, ref: "WorkoutData"}],         //Workout data
});

//Schema for creating a new exercise template (library)
let ExerciseTemplate = new Schema({
...
//Schema for creating a new workout template (library)
let WorkoutTemplate = new Schema({
    name: { type: String, required: true },
    description: { type: String, required: true },
    exercises: [{ type: Schema.Types.ObjectId, ref: "ExerciseTemplate", required: true}]
